...
function initParticles() {
    ...
    let container = document.querySelector('.hero-particles');
    if (!container) {
...
function initMinimalCursor() {
    ...
    document.querySelectorAll('a, button, input, select, .destination-card').forEach(el => {
...
// 4. Section title line animation
